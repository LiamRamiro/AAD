...
namespace Services
{
    public class ProvinciaRepositorio : IProvinciaRepositorio
    {
        ...
        {
            return context.Provincia.FromSqlRaw<Provincia>("SELECT * FROM provincias").ToList();
        }
        ...
        {
            IEnumerable<Provincia> provincias = context.Provincia;
